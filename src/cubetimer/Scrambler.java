...
public class Scrambler {
    ...
    public void randomCorrectScrambleInFieldsUsingFields() {
        ...
        Actions.setScrambleInFields(fields, randomCorrectScramble(fields
            .getAllUsers().getUser().getTwistyPuzzleType(), fields.getAllUsers()
            .getUser().getTwistyPuzzle().getScrambleLength()));
